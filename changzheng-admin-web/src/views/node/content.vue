  ...
  <div class="node-content">
    ...
    <el-dialog v-model="dialogVisible" :title="isEdit ? '编辑内容' : '添加内容'" width="700px">
      <el-form :model="form" :rules="rules" ref="formRef" label-width="100px">
        ...
        <!-- 视频/音频URL -->
        <el-form-item v-if="form.contentType === 'video' || form.contentType === 'audio'" label="媒体URL" prop="mediaUrl">
          <el-input v-model="form.mediaUrl" placeholder="请输入视频/音频链接">
            <template #append>
              <el-button>上传</el-button>
            </template>
          </el-input>
          <div class="form-tip">支持 mp4、mp3 等格式，建议使用 CDN 链接</div>
        </el-form-item>

        <!-- 图片URL -->
        <el-form-item v-if="form.contentType === 'image'" label="图片URL" prop="mediaUrl">
          <el-input v-model="form.mediaUrl" placeholder="请输入图片链接">
            <template #append>
              <el-button>上传</el-button>
            </template>
          </el-input>
        ...
        <el-form-item label="封面图" prop="coverUrl">
          <el-input v-model="form.coverUrl" placeholder="内容封面图URL（可选）" />
        </el-form-item>
