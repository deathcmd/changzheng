...
Please use the repository's [GitHub private vulnerability reporting form](https://github.com/deathcmd/changzheng/security/advisories/new). Do not publish exploitable details, credentials, personal data, or production URLs in a public issue.
